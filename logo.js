...
function createLogoElement() {
  ...
  div.className = 'absolute p-2 top-3 left-3 z-10 cursor-pointer chatGPT-logo buttonHoverBackground buttonHoverOpacity rounded-full  active:!ring-white/50 buttonActiveRing buttonActiveOpacity buttonActiveBackground !transition-none active:!transition';
  div.innerHTML = `
